...
bool InitializeGLEW()
{
	...
	std::cout << std::endl;
	std::cout << "\n*** KEY FUNCTIONS: ***\n";
	std::cout << "ESC - Close The Window & Exit\n";
	std::cout << "W - Zoom In\t" << "S - Zoom Out\n";
	std::cout << "A - Pan Left\t" << "D - Pan Right\n";
	std::cout << "Q - Pan Up\t" << "E - Pan Down\n";
	std::cout << "O - Orthographic Front View\t" << "P - Perspective Front View\n";
	std::cout << "Mouse Wheel Up - Camera Speed Up\t" << "Mouse Wheel Down - Camera Speed Down\n";
	std::cout << std::endl;
	std::cout << std::endl;
	return(true);
}